...
<body>
    <div class="container">
        <form method="POST" action="verifyindex.php" class="login-form">
            <div class="login-box">
                ...
                <button type="submit" id="log" name="log" class="login-button">Login</button>

                <p class="signup-text">Don't have an account? <a href="signup.php">Sign Up</a></p>

                <?php if(isset($_SESSION['msg'])): ?>
                    <span class="message"><?php echo $_SESSION['msg']; unset($_SESSION['msg']); ?></span>
                <?php endif; ?>
